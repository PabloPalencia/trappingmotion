...
This vignette will guide you throught the main functions included in the package. Briefly, we will identify movement behaviours (states) in a red deer population sampled with camera-traps, we will estimate the average mean speed of each behaviour, and finally, we will estimate day range. For that, we will analyse the dataset 'RedDeerdata' provided in the package.
